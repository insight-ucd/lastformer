...
net_G=SiamUnet_conc        #ChangeFormerV6 is the finalized verion
...
pretrain=/home/brendan/LASTFormer/ChangeFormer-maincheckpoints/CD_SiamUnet_conc_LEVIR_b8_lr0.01_sgd_train_test_200_linear_ce/Sunetconc_best_ckpt.pt
...
project_name=UCD_${net_G}_${data_name}_b${batch_size}_lr${lr}_${optimizer}_${split}_${split_val}_${max_epochs}_${lr_policy}_${loss}_multi_train_${multi_scale_train}_multi_infer_${multi_scale_infer}_shuffle_AB_${shuffle_AB}
