...
checkpoints_root=/home/brendan/LASTFormer/ChangeFormer-maincheckpoints/2aCD_base_transformer_pos_s4_dd8_change256_b8_lr0.0001_adamw_train_valid_200_linear_BK_Dice_CE_Loss_multi_train_True_multi_infer_False_shuffle_AB_False_embed_dim_256/
